...
export async function seedSport() {
	console.log("🌱 Starting sport seeding...");
	...
	try {
		...
		// Create sports
		console.log("📝 Creating sport records...");
		...
		console.log(`✅ Successfully created ${sportData.length} sport records`);
		...
		console.log("\n📊 Sport Summary:");
		console.log(`   📧 Email sports: ${emailCount}`);
		console.log(`   📱 SMS sports: ${smsCount}`);
		console.log(`   🔔 Push sports: ${pushCount}`);
		console.log(`   📋 Form sports: ${formCount}`);
		console.log(`   ❓ Unclassified: ${nullCount}`);
		console.log(`   📈 Total: ${sportData.length}`);

		console.log("\n🎉 Sport seeding completed successfully!");
	} catch (error) {
		console.error("❌ Error during sport seeding:", error);
		throw error;
	}
}
