...
export async function seedBet() {
	console.log("🌱 Starting bet seeding...");
	...
	try {
		...
		console.log("🗑️  Clearing existing bets...");
		await prisma.bet.deleteMany({});

		// Create bets
		console.log("📝 Creating bet records...");
		...
		console.log(`✅ Successfully created ${betData.length} bet records`);
		...
		console.log("\n📊 Bet Summary:");
		console.log(`   📧 Email bets: ${emailCount}`);
		console.log(`   📱 SMS bets: ${smsCount}`);
		console.log(`   🔔 Push bets: ${pushCount}`);
		console.log(`   📋 Form bets: ${formCount}`);
		console.log(`   ❓ Unclassified: ${nullCount}`);
		console.log(`   📈 Total: ${betData.length}`);

		console.log("\n🎉 Bet seeding completed successfully!");
	} catch (error) {
		console.error("❌ Error during bet seeding:", error);
		throw error;
	}
}
