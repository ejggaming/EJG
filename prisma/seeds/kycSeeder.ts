...
export async function seedKyc() {
	...
	try {
		...
		console.log("🗑️  Clearing existing kycs...");
		...
		console.log(`✅ Successfully created ${kycData.length} kyc records`);
		...
		console.log("\n📊 Kyc Summary:");
		console.log(`   📧 Email kycs: ${emailCount}`);
		console.log(`   📱 SMS kycs: ${smsCount}`);
		console.log(`   🔔 Push kycs: ${pushCount}`);
		console.log(`   📋 Form kycs: ${formCount}`);
		console.log(`   ❓ Unclassified: ${nullCount}`);
		console.log(`   📈 Total: ${kycData.length}`);

		console.log("\n🎉 Kyc seeding completed successfully!");
	} catch (error) {
		console.error("❌ Error during kyc seeding:", error);
		throw error;
	}
}
