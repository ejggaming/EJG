...
export async function seedEvent() {
	...
	try {
		...
		console.log(`✅ Successfully created ${eventData.length} event records`);
		...
		console.log("\n📊 Event Summary:");
		console.log(`   📧 Email events: ${emailCount}`);
		console.log(`   📱 SMS events: ${smsCount}`);
		console.log(`   🔔 Push events: ${pushCount}`);
		console.log(`   📋 Form events: ${formCount}`);
		console.log(`   ❓ Unclassified: ${nullCount}`);
		console.log(`   📈 Total: ${eventData.length}`);
