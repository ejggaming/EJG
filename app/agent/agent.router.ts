...
export const router = (route: Router, controller: IController): Router => {
	 ...
	 *     description: Retrieve a specific agent by its unique identifier with optional field selection
	 *     tags: [Agent]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *         description: Agent ID (MongoDB ObjectId format)
	 ...
	 */
	// Cache individual agent with predictable key for invalidation
	routes.get(
		"/:id",
		cache({
			ttl: 90,
			keyGenerator: (req: Request) => {
				...
				return `cache:agent:byId:${req.params.id}:${fields}`;
			},
		}),
		controller.getById,
	);
	 ...
	 *     description: Retrieve agents with advanced filtering, pagination, sorting, field selection, and optional grouping
	 *     tags: [Agent]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *           type: string
	 *           enum: ["true"]
	 *         description: Include agent documents in response
	 *       - in: query
	 *         name: pagination
	 *         required: false
	 *         schema:
	 ...
	 *         $ref: '#/components/responses/InternalServerError'
	 */
	// Cache agent list with predictable key for invalidation
	routes.get(
		"/",
		cache({
			ttl: 60,
			keyGenerator: (req: Request) => {
				...
				return `cache:agent:list:${queryKey}`;
			},
		}),
		controller.getAll,
	);
	 ...
	 *                 example: "Email Welcome Agent"
	 *               description:
	 *                 type: string
	 *                 description: Agent description
	 *                 example: "Welcome email agent for new users"
	 *               type:
	 *                 type: string
	 ...
	 *     description: Update agent data by ID (partial update)
	 *     tags: [Agent]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *     description: Permanently delete a agent by ID
	 *     tags: [Agent]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
