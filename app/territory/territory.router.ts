...
export const router = (route: Router, controller: IController): Router => {
	 ...
	 *     description: Retrieve a specific territory by its unique identifier with optional field selection
	 *     tags: [Territory]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *         description: Territory ID (MongoDB ObjectId format)
	 ...
	 */
	// Cache individual territory with predictable key for invalidation
	routes.get(
		"/:id",
		cache({
			ttl: 90,
			keyGenerator: (req: Request) => {
				...
				return `cache:territory:byId:${req.params.id}:${fields}`;
			},
		}),
		controller.getById,
	);
	 ...
	 * /api/territory:
	 *   get:
	 *     summary: Get all territorys
	 *     description: Retrieve territorys with advanced filtering, pagination, sorting, field selection, and optional grouping
	 *     tags: [Territory]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *           type: string
	 *           enum: ["true"]
	 *         description: Include territory documents in response
	 *       - in: query
	 *         name: pagination
	 *         required: false
	 *         schema:
	 ...
	 *         $ref: '#/components/responses/InternalServerError'
	 */
	// Cache territory list with predictable key for invalidation
	routes.get(
		"/",
		cache({
			ttl: 60,
			keyGenerator: (req: Request) => {
				...
				return `cache:territory:list:${queryKey}`;
			},
		}),
		controller.getAll,
	);
	 ...
	 *     description: Create a new territory with the provided data
	 *     tags: [Territory]
	 *     security:
	 *       - bearerAuth: []
	 *     requestBody:
	 ...
	 *                 example: "Email Welcome Territory"
	 *               description:
	 *                 type: string
	 *                 description: Territory description
	 *                 example: "Welcome email territory for new users"
	 *               type:
	 *                 type: string
	 *                 enum: ["email", "sms", "push", "form"]
	 *                 description: Territory type for categorization
	 *                 example: "email"
	 *               isDeleted:
	 *                 type: boolean
	 ...
	 *     description: Update territory data by ID (partial update)
	 *     tags: [Territory]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
	 ...
	 *                 minLength: 1
	 *                 description: Territory name
	 *                 example: "Updated Email Territory"
	 *               description:
	 *                 type: string
	 *                 description: Territory description
	 *                 example: "Updated description for the territory"
	 *               type:
	 *                 type: string
	 *                 enum: ["email", "sms", "push", "form"]
	 *                 description: Territory type for categorization
	 ...
	 *     description: Permanently delete a territory by ID
	 *     tags: [Territory]
	 *     security:
	 *       - bearerAuth: []
	 *     parameters:
